      ...
      <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
        {pctBB != null && (
          <div style={{
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: pctBB >= 85 ? '#7ee787' : pctBB >= 70 ? '#ffa657' : '#f85149' }}>
              {pctBB}%
            </div>
            <div style={{ fontSize: 9, color: '#8b949e', textTransform: 'uppercase', letterSpacing: 0.5 }}>
              have broadband
            </div>
          </div>
        )}
        {pctNo != null && (
          <div style={{
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: pctNo >= 15 ? '#f85149' : pctNo >= 5 ? '#ffa657' : '#7ee787' }}>
              {pctNo}%
            </div>
            <div style={{ fontSize: 9, color: '#8b949e', textTransform: 'uppercase', letterSpacing: 0.5 }}>
              no internet
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          {insights.map((ins, i) => (
            <div key={i} style={{
              ...
              <span style={{ color: ins.color, fontWeight: 600, fontSize: 9, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                {ins.label}
              </span>
